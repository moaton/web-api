...
// Debugw provides a mock function with given fields: template, args
func (_m *Logger) Debugw(template string, args ...interface{}) {
	var _ca []interface{}
...
// Errorw provides a mock function with given fields: template, args
func (_m *Logger) Errorw(template string, args ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, template)
	_ca = append(_ca, args...)
	_m.Called(_ca...)
...
// Fatalw provides a mock function with given fields: template, args
func (_m *Logger) Fatalw(template string, args ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, template)
	_ca = append(_ca, args...)
	_m.Called(_ca...)
...
// Infow provides a mock function with given fields: template, args
func (_m *Logger) Infow(template string, args ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, template)
	_ca = append(_ca, args...)
	_m.Called(_ca...)
...
// Warnw provides a mock function with given fields: template, args
func (_m *Logger) Warnw(template string, args ...interface{}) {
	var _ca []interface{}
	_ca = append(_ca, template)
	_ca = append(_ca, args...)
	_m.Called(_ca...)
